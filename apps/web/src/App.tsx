 ...
 * A tela da Fase 0.
 *
 * Ela existe para responder uma pergunta só: **o ambiente está de pé?** Os
 * recursos da rede chegam nas fases seguintes; esta tela é o alicerce que
 * permite descobrir cedo um problema de certificado ou de permissão, quando
 * ainda não há mais nada para confundir o diagnóstico.
 */
export function App(): React.ReactElement {
  ...
  return (
    <main className="mx-auto flex min-h-dvh max-w-lg flex-col gap-6 px-5 py-8">
      <header>
        <p className="text-texto-suave text-sm font-medium">Fase 0 · fundação</p>
        ...
        <p className="text-texto-suave mt-3 text-[15px] leading-relaxed">
          {problemas === 0
            ? 'Tudo pronto por aqui. Os recursos da rede chegam nas próximas fases.'
            : `${problemas === 1 ? 'Um item precisa' : `${problemas} itens precisam`} da sua atenção antes de seguir.`}
        </p>
      </header>
      ...
      <footer className="text-texto-suave mt-auto pt-6 text-xs leading-relaxed">
        Suas conversas serão protegidas com criptografia ponta-a-ponta — nem este servidor consegue
